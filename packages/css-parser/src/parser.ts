/**
 * CSS Parser - Parses CSS into wolf-tui Styles objects
 */

import postcss from 'postcss';
import type { ParsedStylesheet, ParsedRule, ParsedStyles, CSSParserOptions } from './types.js';
...
export function extractClassName(selector: string): string | null {
	...
	// Skip element-only selectors (e.g., div, body)
 ...
 */
export function parseCSS(css: string, options?: CSSParserOptions): ParsedStyles {
...
export { type ParsedStylesheet, type ParsedRule, type ParsedStyles, type CSSParserOptions };
